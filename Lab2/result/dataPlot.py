...
img_loss = getData("./r1_img.csv")
img_with_noise = getData("./r1_img_with_noise.csv")
r1_shuffle1 = getData("./r1_new_shuffle.csv")
r1_shuffle = getData("./r1_shuffle.csv")
r1_only_noise = getData("./r1_only_noise.csv")
...
plt.plot(epoch, r1_shuffle, label="Image shuffled")
